  ...
  <div id="kelas-detail-page" v-if="dataKelas">
    ...
    <div class="vx-row mt-4">
      <div class="vx-col w-1/2 md:w-1/3">
        <div class="btn-card"
          @click="$router.push('/dosen/kelas/' + kode + '/materi')"
        >
      ...
      <div class="vx-col w-1/2 md:w-1/3">
        <div
          class="btn-card"
          @click="$router.push('/dosen/kelas/' + kode + '/tugas')"
        >
          <statistics-card-line
            hideChart
            class="mb-base"
      ...
      <div class="vx-col w-1/2 md:w-1/3">
        <div class="btn-card"
          @click="$router.push('/dosen/kelas/' + kode + '/kuis')"
        >
          <statistics-card-line
            hideChart
            class="mb-base"
      ...
      <div class="vx-col w-1/2">
        <div class="btn-card" @click="openVideoConference">
          <statistics-card-line
            hideChart
            class="mb-base"
            icon="VideoIcon"
            statistic="Click to Start"
            statisticTitle="Video Conference"
            color="danger"
          />
        </div>
      </div>
